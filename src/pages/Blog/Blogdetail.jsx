const Blogdetail = () => {
  return (
    <>
      ...
      <main className="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-transparent text-white">
        <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
          <article className="mx-auto w-full max-w-2xl htmlFormat htmlFormat-sm sm:htmlFormat-base lg:htmlFormat-lg htmlFormat-blue dark:htmlFormat-invert">
            ...
            <p>
              BehtmlFore going digital, you might benefit from scribbling down
              some ideas in a sketchbook. This way, you can think things through
              behtmlFore committing to an actual design project.
            </p>
            <p>
              But then I found a{" "}
              ...
              buttons, navigation bars, cards, htmlForm elements, and more which
              are conveniently built with the utility classNamees from Tailwind
              CSS.
            </p>
            <figure>
              <img
            ...
            <pre>
              <code className="language-html">
                <div className="grid grid-cols-2 gap-8 max-w-screen-md text-gray-900 sm:grid-cols-3 dark:text-white">
